...
title: Avoid The Bike Shed - Don't Get Hung Up On Community Software
description: The most frequent question I'm asked is what software I recommend using for building a community. Here's why that's the wrong question to ask, and what to think about instead.
authors: [tpost]
image: ./community-growth-og.png
tags: [community-strategy]
---

There are two things that I want you to remember above everything else when 
it comes to initially fostering a new community:
...
seems a _little_ over-simplified to you and you're not wrong. I'll do 
my best to explain it in less than five minutes, novice or expert!
...
See? That only took about four minutes, but you might have just saved a lot
of time.