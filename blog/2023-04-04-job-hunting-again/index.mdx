...
image: /img/blog/job-hunting/adventure-og.png
authors: [tpost]
tags: [job]
---
...
<a href="/blog/job-hunting/">
    <img
        src="/img/blog/job-hunting/adventure-og.png" 
        className="blogImage"
        alt="Artwork representing a new adventure"
        title="Never fun, but always exciting!"
    />
</a>
