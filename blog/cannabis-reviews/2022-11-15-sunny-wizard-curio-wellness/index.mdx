...
<a href="/blog/sunny-wizard-by-curio-wellness">
    <img 
        src="/img/reviews/curio-sunny-wizard/curio-sunny-wizard.avif" 
        className="blogImage" 
        alt="Dried Cannabis Flower"
        title="Sunny Wizard By Curio Wellness"
    />
</a>
...
| --- | --- |
| THC | 0.44% |
| THCa | 27.27% <small>(Note that this is relative to the total THC content of the plant. If the plant itself is 35% THC, then 10% THC-A Means 10% of that 35%. for example.)</small> |
| CBD   | nil |
| CBGa  | 0.23% |
